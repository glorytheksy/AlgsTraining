...
public class SkipList {
     ...
     */
    public triDirectNode<Integer> get(Integer element) {
    ...
    public void delete(Integer element) {
        ...
        triDirectNode<Integer> node = this.get(element);
        while (null != node) {            
    ...
    public static void main(String[] args) {
        ...
        System.out.println("10: " + list.get(10));
        System.out.println("11: " + list.get(11));
